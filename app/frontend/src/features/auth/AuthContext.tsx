...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const login = useCallback(async (formData: LoginFormData) => {
    ...
    try {
      ...
      console.log('AuthContext: Login successful, user authenticated:', response.user)
      return { success: true }
    } catch (error) {
  ...
  const register = useCallback(async (formData: RegisterFormData) => {
    ...
    try {
      ...
      console.log('AuthContext: Registration successful, user authenticated:', response.user)
      return { success: true }
    } catch (error) {
      const message = error instanceof ApiException 
        ? error.data.message 
